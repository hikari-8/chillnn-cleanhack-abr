...
export declare class RaffleObjectModel extends BaseModel<RaffleObject> {
    static getBlanc(tasks: Array<RaffleMast>, groupID: Scalars["String"], limitHour: Scalars["Int"], limitMin: Scalars["Int"], raffleStatus: RaffleStatus, remindSlackHour: Scalars["Int"], remindSlackMin: Scalars["Int"], slackURL: Scalars["String"], activeMembers: Array<RaffleJoinUser>): RaffleObject;
    get raffleID(): string;
    get groupID(): string;
